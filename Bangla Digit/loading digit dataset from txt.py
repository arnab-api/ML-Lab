...
train_data = numpy.loadtxt("razikBhai_train.txt", delimiter=",")
test_data = numpy.loadtxt("razikBhai_test.txt", delimiter=",")
...
with open("model_digit_bord_razikvai.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_digit_bord_razikvai.h5")
